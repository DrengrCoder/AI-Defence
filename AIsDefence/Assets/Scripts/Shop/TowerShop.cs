...
public class TowerShop : MonoBehaviour {
    ...
    //        tower._currentUpgradeCost = tower._baseUpgradeCost;
    //        tower._futureCostPointer = 0;
    ...
    //    {
    //        string text = _towerPrefabs[i].GetComponent<Tower>()._currentUpgradeCost.ToString() + "QE";
    //        if (_towerPrefabs[i].GetComponent<Tower>()._currentUpgradeCost < 1)
    //        {
    //            text = "MAXED";
    //        }
    ...
    //        _bank.MinusCredits(baseTower._currentUpgradeCost);
    ...
    //        baseTower._currentUpgradeCost = baseTower._futureCosts[++baseTower._futureCostPointer];
    ...
    //                instancedTower._currentUpgradeCost = baseTower._currentUpgradeCost;
    ...
    //        if (baseTower._futureCostPointer + 1 >= baseTower._maxUpgrades)
    //        {
    //            _upgradeButtons[pressedButton].GetComponentInChildren<Text>().text = "MAXED";
    //            baseTower._currentUpgradeCost = 0;
    //        }
    ...
    //        if (t._currentUpgradeCost <= _bank.CreditBank && t._currentUpgradeCost > 0)
    //        {
